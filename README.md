...
| [Open Agent Relay](https://github.com/ShakespeareLabs/open-agent-relay)                            | Local capability relay       | Exposes allowlisted Claude Code and Codex workflows over a trusted LAN while prompts, credentials, dependencies, and working directories stay on the operator's machine. |
